  ...
  return (
    <div>
      <div className="mb-[40px]">
        <div className="flex w-[550px] mb-4 ml-[40px]">
      ...
      <div className="flex justify-end mr-[40px] mt-[10px]">
        <div className="w-[70px] h-[25px] bg-gray-300 rounded"></div>
      </div>
      <p className="border border-[#D9D9D9] w-[520px] m-auto mt-[40px]"></p>
      ...
      <div className="mt-[30px]">
        <div className="w-[70px] h-[25px] bg-gray-300 rounded mr-[470px] mb-[10px]"></div>
        <div className="w-[70px] h-[25px] bg-gray-300 rounded ml-[50px]"></div>
        <p className="border border-[#D9D9D9] w-[520px] m-auto"></p>
        <div className="w-[70px] h-[25px] bg-gray-300 rounded mr-[450px] mt-[10px] mb-[10px]"></div>
        <div className="w-[70px] h-[25px] bg-gray-300 rounded ml-[50px]"></div>
        <p className="border border-[#D9D9D9] w-[520px] m-auto"></p>
        <div className="w-[70px] h-[25px] bg-gray-300 rounded mr-[460px] mt-[10px] mb-[10px]"></div>
        <div className="w-[70px] h-[25px] bg-gray-300 rounded ml-[50px]"></div>
        <p className="border border-[#D9D9D9] w-[520px] m-auto "></p>
      </div>

      <div className="text-left ml-[40px] mt-[40px] ">
        <div className="w-[70px] h-[25px] bg-gray-300 rounded mb-[5px]"></div>
      </div>
